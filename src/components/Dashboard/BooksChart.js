      ...
      <div className="col-12 col-lg-3 d-flex">
        <div className="card rounded-4 w-100">
          <div className="card-body">
            ...
            <ApexCharts
              options={createChart(
                [10, 30, 50, 80, stats.totalOrders],
                "#007bff"
              )}
              series={[
                {
                  name: "Books Sold",
                  data: [10, 30, 50, 80, stats.totalOrders],
                },
              ]}
              type="area"
              height={80}
      ...
      <div className="col-12 col-lg-3 d-flex">
        <div className="card rounded-4 w-100">
          <div className="card-body">
            ...
            <ApexCharts
              options={createChart(
                [5, 20, 50, 100, stats.lastMonthOrders],
                "#28a745"
              )}
              series={[
                {
                  name: "Books Sold",
                  data: [5, 20, 50, 100, stats.lastMonthOrders],
                },
              ]}
              type="area"
              height={80}
      ...
      <div className="col-12 col-lg-3 d-flex">
        <div className="card rounded-4 w-100">
          <div className="card-body">
            ...
            <ApexCharts
              options={createChart(
                [1, 5, 15, 30, stats.lastWeekOrders],
                "#17a2b8"
              )}
              series={[
                {
                  name: "Books Sold",
                  data: [1, 5, 15, 30, stats.lastWeekOrders],
                },
              ]}
              type="area"
              height={80}
        ...
        <div className="card rounded-4 w-100">
          <div className="card-body">
            ...
            <ApexCharts
              ...
              series={[
                { name: "Books Sold", data: [0, 2, 5, 7, stats.dailyOrders] },
              ]}
              type="area"
              height={80}
            />
