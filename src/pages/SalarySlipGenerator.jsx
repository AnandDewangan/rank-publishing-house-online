...
const SalarySlipGenerator = () => {
  ...
  const employees = [
    { name: 'Anand Dewangan', id: 'RANK2501', designation: 'Software Developer', department: 'IT' },
    { name: 'Rakesh Sahu', id: 'RANK2502', designation: 'Project Manager & Book Interior Designer', department: 'Project Management / Publishing / Design' },
    { name: 'Lileshwari Verma', id: 'RANK2503', designation: 'Sales Executive & Distribution', department: 'Sales & Distribution' },
    { name: 'Koitoor Kalap', id: 'RANK2504', designation: 'Graphic & Motion Designer', department: 'Creative / Design' }
  ];
  ...
  const generatePDF = () => {
    ...
    const adjustedBasic = ((basicNum / 30) * (30 - Number(leaveDays))).toFixed(2);
    const net = Number(adjustedBasic) + Number(hra) + Number(allowances) - Number(deductions);
    ...
    doc.setFontSize(10);
    doc.text("Note: Adjusted Basic Salary is calculated based on leaves taken.", 14, doc.lastAutoTable.finalY + 10);
